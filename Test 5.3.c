...
// ------ Setup do jogo ------
    ...
    //---- Variaveis globais ----
        ...
        int playerFacing = 0; // DireÁ„o que o jogador est· olhando
...
void inicializarVariaveis() {
    playerX = 0; // PosiÁ„o inicial do jogador
    playerY = 0; // PosiÁ„o inicial do jogador
    itemCount = 0; // Contador de itens no inventùrio
    for (i = 0; i < 9; i++) {
...
void vila() {
    ...
    inicializarMatriz(); 
    map[5][4] = 1; //NPC
    map[5][3] = 6; //Ativacao do tutorial
...
int atualizarMatriz() {
    ...
    {
        // playerFacing È a direÁ„o que o jogador est· olhando, de acordo com o comando. E W, A, S, D s„o as teclas de movimentaÁ„o.
        ...
        if (_kbhit()) {
            ...
            if (comando == 'E' || comando == 'e') {
                ...
                {
                case 1:
                    printf("VocÍ interagiu com o NPC!\n");
                    break;

                case 4:
                    printf("VocÍ entrou na casa!\n");
                    playerLocation = 0;
                    casa();
                    break;
                case 5:
                    printf("VocÍ saiu da casa!\n");
                    playerLocation = 0;
                    vila();
                    break;
           ...
           // ---------- Verificaùùo do Limite da matriz e Atualizacao da posicao do jogador ------------------------
...
void Creditos() {
        ...
        playerY = 3; 
        map[5][4] = 1; //NPC
        map[5][3] = 2; //Ativacao do tutorial
        map[2][5] = 4; //ponto de transicao
        system ("pause");
        system ("cls");
        inicializarMatriz(); 
...
// ======= funcoes de utilidade para o inventùrio ========
    // funÁ„o para exibir o invent·rio
    void exibirInventario() {
        system ("cls");
        system ("color 0A");
        printf("Invent·rio:\n");
        ...
        for (i = 0; i < inventorySize; i++) {
            if (inventory[i] != 0) { // Verifica se o espaÁo do invent·rio n„o est· vazio
                ...
                printf("%s ", item); // Exibe o item no inventario
            }
        }
